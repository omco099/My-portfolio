...
const projectsData = [
  ...
  { title: "مشروع 18", link: "https://phllog.com" },
  { title: "مشروع 19", link: "https://abdullah-elgharbawy.com" },
  { title: "مشروع 20", link: "https://aleumranalfarid.com" }
];
  ...
  projectsData.forEach(project => {
    ...
    card.innerHTML = `
      <a
        ...
        target="_blank"
        rel="noopener"
        aria-label="زيارة موقع ${project.title}"
      >
        ${project.title}
      </a>
    `;
